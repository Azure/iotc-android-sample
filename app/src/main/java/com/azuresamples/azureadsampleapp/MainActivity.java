...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String RESOURCE_ID = Constants.IOTC_TOKEN_AUDIENCE;
    ...
    private void updateSuccessUI(String text) {
    ...
    private AuthenticationCallback<AuthenticationResult> getAuthSilentCallback() {
        return new AuthenticationCallback<AuthenticationResult>() {
            ...
            public void onSuccess(AuthenticationResult authenticationResult) {
                ...
                /* call graph */
                try {
                    iotcentral = new DataClient(mAuthResult.getAccessToken());
                    apps = iotcentral.listApps();
                    final String text = "Found " + apps.length + " applications";
                    /* update the UI to post call graph state */
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            updateSuccessUI(text);
                        }
                    });
